...
# --------------------------------------------------------------------------- #
# folder_20251029 = folder_ftp + 'BACYdata/'
# files = sorted(glob.glob(folder_20251029 + '*'))
# for file in files:
#     if file[-4:] == '.tgz':
#         print('tar zxvf ' + file + ' -C ' + folder_mod)
#         os.system('tar zxvf ' + file + ' -C ' + folder_mod)
...
# --------------------------------------------------------------------------- #
# folder_20251217 = folder_ftp + 'BACYdata/'
# files = sorted(glob.glob(folder_20251217 + '*'))
# for file in files:
#     if file[-4:] == '.tgz':
#         print('tar zxvf ' + file + ' -C ' + folder_mod)
#         os.system('tar zxvf ' + file + ' -C ' + folder_mod)
...
# # --------------------------------------------------------------------------- #
# folder_20260120 = folder_ftp + 'BACYdata/'
# files = sorted(glob.glob(folder_20260120 + '*'))
# for file in files:
#     if file[-4:] == '.tgz':
#         print('tar zxvf ' + file + ' -C ' + folder_mod)
#         os.system('tar zxvf ' + file + ' -C ' + folder_mod)
...
# --------------------------------------------------------------------------- #
# folder_20260127 = folder_ftp + 'BACYdata/'
# files = sorted(glob.glob(folder_20260127 + '*'))
# for file in files:
#     if file[-4:] == '.tgz':
#         print('tar zxvf ' + file + ' -C ' + folder_mod)
#         os.system('tar zxvf ' + file + ' -C ' + folder_mod)
...
# --------------------------------------------------------------------------- #
folder_20260218 = folder_ftp + 'BACYdata/'
files = sorted(glob.glob(folder_20260218 + '*'))
for file in files:
    if file[-4:] == '.tgz':
        print('tar zxvf ' + file + ' -C ' + folder_mod)
        os.system('tar zxvf ' + file + ' -C ' + folder_mod)
