...
### Better colormaps
from radar_processing_scripts.colormap_generator import *
...
# Radardata filelist
file_list_gen = create_dwd_filelist(path=realpep_path,
...
# vol.to_netcdf(header.dir_data_obs)
swp.to_netcdf(header.dir_data_obs+'/test.nc')
