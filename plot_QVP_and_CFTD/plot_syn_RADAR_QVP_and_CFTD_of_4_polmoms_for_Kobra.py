...
# short_names.append(icon_emvorado_runs[-1][-10:])
...
# ------------------------------------ #
da_runs.append('ASS_2411')
icon_emvorado_runs.append('MAIN_2411.3/EMVO_00511300.2')
spin_up_mms.append('120')
# short_names.append(icon_emvorado_runs[-1][-10:])
short_names.append(icon_emvorado_runs[-1][5:-15]+icon_emvorado_runs[-1][-10:] + '/' + spin_up_mms[-1])
...
# ------------------------------------ #
da_runs.append('ASS_2411')
icon_emvorado_runs.append('MAIN_2411.3/EMVO_00521300.2')
spin_up_mms.append('120')
# short_names.append(icon_emvorado_runs[-1][-10:])
short_names.append(icon_emvorado_runs[-1][5:-15]+icon_emvorado_runs[-1][-10:] + '/' + spin_up_mms[-1])
colors.append('green')
...
# ------------------------------------ #
da_runs.append('ASS_2411')
icon_emvorado_runs.append('MAIN_2411.3/EMVO_01521300.2')
spin_up_mms.append('120')
# short_names.append(icon_emvorado_runs[-1][-10:])
short_names.append(icon_emvorado_runs[-1][5:-15]+icon_emvorado_runs[-1][-10:] + '/' + spin_up_mms[-1])
...
scale_font = 1.
scale_numbers = 1.
# fig = plt.figure(figsize=(n_cols * 3., n_rows * 3.), layout='constrained')
...
axs[-1,-1].set_xticks(axs[-1,-1].get_xticks(), ['02', '04', '06', '08', '10', '12', '14', '16', '18', '20'])
axs[-1,-1].set_xlabel('UTC [hh]', fontsize=12 * scale_font)
axs[-1,-2].set_xticks(axs[-1,-2].get_xticks(), ['02', '04', '06', '08', '10', '12', '14', '16', '18', '20'])
axs[-1,-2].set_xlabel('UTC [hh]', fontsize=12 * scale_font)
axs[-1,-3].set_xticks(axs[-1,-3].get_xticks(), ['02', '04', '06', '08', '10', '12', '14', '16', '18', '20'])
axs[-1,-3].set_xlabel('UTC [hh]', fontsize=12 * scale_font)
axs[-1,-4].set_xticks(axs[-1,-4].get_xticks(), ['02', '04', '06', '08', '10', '12', '14', '16', '18', '20'])
...
for i_r in range(n_rows):
    for i_c in range(n_cols):
        ...
        if i_c==1:
            axs[i_r,i_c].set_xlim([mom_plot_dict('ZDR')['mom_min'], 3.4])
