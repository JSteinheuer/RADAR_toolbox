...
spin_up_mms.append('120')
# colors.append('pink')  # bad
# colors.append('cyan')
colors.append('purple')  # maybe
# # ------------------------------------ #
# SYN data row 5                       #
# ------------------------------------ #
da_runs.append('ASS_2411')
...
# n_cols = 4
# plt.figure(figsize=(n_cols * 12, n_rows * 9))  # TODO
# n_i = 0
# current_row = 0
#
# # --------------------------------------------------------------------------- #
...
# if filter_entr:
#     obs_nc=obs_nc.where(obs_nc['min_entropy']>0.7)
#
# # ------------------------------------ #
...
#
#     if filter_entr:
#         syn_nc = syn_nc.where(syn_nc['min_entropy'] > 0.7)
#
...
#
# plt.savefig(
#     folder_plot + 'paperQVP_4polmoms_' + str(elevation_deg) + '_' +
#     date + '_' + hhmm_start + '-' + hhmm_end + '_' +
#     location + mod_names + ['', 'entr_'][filter_entr] +
...
# CBAND SYN row i                                                             #
# --------------------------------------------------------------------------- #
for da_run, icon_emvorado_run, spin_up_mm, color in zip(
        da_runs, icon_emvorado_runs, spin_up_mms, colors):
...
plt.savefig(
    folder_plot + '/paperCFTD_4polmoms_' + str(elevation_deg) + '_' +
