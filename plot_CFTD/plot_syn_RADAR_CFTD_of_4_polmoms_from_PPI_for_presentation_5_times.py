...
import glob
import numpy as np
from PLOT_SYN_RADAR import (mom_plot_dict,
                            plot_CFAD_or_CFTD_from_PPI_with_list,
...
# plt.savefig(
#     folder_plot +
#     '/NEW/CFTDs_' + str(n_rows)+ 'x4polmoms_QVP_' +
...
#
# # --------------------------------------------------------------------------- #
# #                       PLOT D1: PPI-BASED 12° ELEVATION                      #
# # --------------------------------------------------------------------------- #
# data_max = None
# elevation_degs = [12]
# # elevation_deg = 12
...
# plt.savefig(
#     folder_plot +
#     '/NEW/CFTDs_' + str(n_rows)+ 'x4polmoms_PPI_' +
...
#
# # --------------------------------------------------------------------------- #
# #                       PLOT E1: PPI-BASED ALL ELEVATION                      #
# # --------------------------------------------------------------------------- #
# data_max = None
...
#
# # --------------------------------------------------------------------------- #
# #                       PLOT D2: PPI-BASED 12° ELEVATION                      #
# # --------------------------------------------------------------------------- #
# data_max = None
# elevation_degs = [12]
# # elevation_deg = 12
...
# --------------------------------------------------------------------------- #
#                       PLOT E2: PPI-BASED ALL ELEVATION                      #
# --------------------------------------------------------------------------- #
data_max = None
elevation_degs = [5.5, 4.5, 3.5, 2.5, 1.5, 0.5, 8, 12, 17, 25]
# elevation_deg = 12
...
#
# --------------------------------------------------------------------------- #
#                       PLOT D3: PPI-BASED 12° ELEVATION                      #
# --------------------------------------------------------------------------- #
data_max = None
elevation_degs = [12]
# elevation_deg = 12
...
# --------------------------------------------------------------------------- #
#                       PLOT E3: PPI-BASED ALL ELEVATION                      #
# --------------------------------------------------------------------------- #
data_max = None
elevation_degs = [5.5, 4.5, 3.5, 2.5, 1.5, 0.5, 8, 12, 17, 25]
# elevation_deg = 12
...
# --------------------------------------------------------------------------- #
#                       PLOT D4: PPI-BASED 12° ELEVATION                      #
# --------------------------------------------------------------------------- #
data_max = None
elevation_degs = [12]
# elevation_deg = 12
...
# --------------------------------------------------------------------------- #
#                       PLOT E4: PPI-BASED ALL ELEVATION                      #
# --------------------------------------------------------------------------- #
data_max = None
elevation_degs = [5.5, 4.5, 3.5, 2.5, 1.5, 0.5, 8, 12, 17, 25]
# elevation_deg = 12
