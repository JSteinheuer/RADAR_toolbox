...
x ,y, freq = plot_CFAD_or_CFTD_from_PPI_with_list_quick(
    locations=locations,
    dates=dates,
...
# --------------------------------------------------------------------------- #
# da_run = da_runs[0]
# icon_emvorado_run = icon_emvorado_runs[0]
# spin_up_mm = spin_up_mms[0]
# color = colors[0]
...
for da_run, icon_emvorado_run, spin_up_mm, color, short_name in zip(
    ...
    # print(current_col)
    # ax = axs[current_row, current_col]
    # x ,y, freq, freq = plot_CFAD_or_CFTD_from_PPI_with_list_quick(
    #     locations=locations,
    #     dates=dates,
    #     hhmm_start=hhmm_start_cftds,
    #     hhmm_end=hhmm_end_cftds,
...
plt.savefig(
    folder_plot +
    '/CFTDs_q_' + str(n_rows)+ 'x4polmoms_PPI_' +
