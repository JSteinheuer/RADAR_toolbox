...
da_run2 = 'ASS_2211'
icon_emvorado_run2 = 'MAIN_2401.1/EMVO_00510000.2'
...
plot_CFAD_or_CFTD_from_QVP(
    ...
    icon_emvorado_run=icon_emvorado_run1,
...
da_run = da_run2
icon_emvorado_run = icon_emvorado_run2
spin_up_mm = '60'
folder_syn = header.dir_data_qvp
current_row = current_row + 1
...
#                        spin_up_mm + 'min'])
mod_names = '-'.join([mod_names2, model_name2])
