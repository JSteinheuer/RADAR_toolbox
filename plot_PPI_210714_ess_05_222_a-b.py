...
file_in_2 = 'ras07-vol5minng01_sweeph5onem_kdp_nc_05-202107140003-202107142358-ess-10410.hd5'
# case (adjust!):
# --------------------------------------------------------------------------- #
# --------------------------------------------------------------------------- #
...
# ----------------------------------- #
step = 7
levels = np.arange(-18*step, 19*step, step)
...
# ----------------------------------- #
step = 7
levels = np.arange(-7*step, 30*step, step)
norm = mpl.colors.BoundaryNorm(levels, len(levels) - 1)
cmap = header.cmap_radar_smooth
# ----------------------------------- #
n_i = n_i + 1
