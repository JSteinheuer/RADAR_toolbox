...
# # nt (9 ticks)
# levels_nt2 = np.linspace(-8, 0, 9)
# norm_nt2 = mpl.colors.BoundaryNorm(levels_nt2, len(levels_nt2) - 1)
# # nt (9 ticks)
# levels_qnt2 = np.linspace(-5, 3, 9)
# norm_qnt2 = mpl.colors.BoundaryNorm(levels_qnt2, len(levels_qnt2) - 1)
# nt (9 ticks)
levels_nt2 = np.linspace(-5, 3, 9)
norm_nt2 = mpl.colors.BoundaryNorm(levels_nt2, len(levels_nt2) - 1)
# nt (9 ticks)
levels_qnt2 = np.linspace(-8, 0, 9)
norm_qnt2 = mpl.colors.BoundaryNorm(levels_qnt2, len(levels_qnt2) - 1)
