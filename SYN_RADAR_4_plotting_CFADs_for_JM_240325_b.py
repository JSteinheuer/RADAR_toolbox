...
# SYN_RADAR_4_plotting_CFADs_for_JM_240325.py                                 #
#                                                                             #
# Run the function in SYN_RADAR_4_CFAD_AND_CFTD.py for generating specific    #
# CFTD.                                                                       #
# --------------------------------------------------------------------------- #
...
da_run = 'ASS_2211'
icon_emvorado_run = 'MAIN_2401.4/EMVO_00500000.2'
spin_up_mm = '60'
...
da_run = 'ASS_2211'
icon_emvorado_run = 'MAIN_2401.4/EMVO_00500002.2'
spin_up_mm = '60'
folder_syn = header.dir_data_qvp
current_row = 3
model_name = '-'.join([da_run[4:],
...
da_run = 'ASS_2211'
icon_emvorado_run = 'MAIN_2401.4/EMVO_00500005.2'
spin_up_mm = '60'
folder_syn = header.dir_data_qvp
current_row = 4
model_name = '-'.join([da_run[4:],
