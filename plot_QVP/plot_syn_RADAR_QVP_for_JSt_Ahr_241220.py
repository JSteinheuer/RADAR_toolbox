...
folder_obs = '/automount/data02/agradar/operation_hydrometeors/' \
             'data/obs_qvp/OpHymet2-caseX-20170725/' \
             '2017/2017-07/2017-07-25/pro/vol5minng01/07/'
# TODO: TS style data?

path = folder_obs + 'ras07-qvp5minng01_sweeph5onem_polmoms_nc_' \
                    '07-201707250003-201707252358-pro-10392.hd5'
obs_nc = xr.open_dataset(path)
