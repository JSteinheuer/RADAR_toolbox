...
icon_emvorado_run = 'MAIN_2411.0/EMVO_00010000.2'
spin_up_mm = '120'
# --------------------------------------------------------------------------- #
# initialize mod/obs                                                          #
# --------------------------------------------------------------------------- #
...
time_i_obs = int(time_hhmm %100 /5 + 0.12*(time_hhmm-time_hhmm %100))
...
if mode == 'vol':
    ...
    title = moment + ' at pcp ' + \
            location.upper() + ' ' + time_UTC_obs
plot_PPI(nc_file, ax, time_i_obs, moment, title=title,lowest_zdr=-1,
             range_max=range_max)
# ----------------------------------------------------------------------- #
# row 2: mod pol moms                                                     #
# ----------------------------------------------------------------------- #
...
file_out = 'Pre-PEP_BOTH_PPI_' + str(elevation_deg) + \
